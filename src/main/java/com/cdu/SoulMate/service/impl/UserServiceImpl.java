...
import com.cdu.SoulMate.mapper.UserMapper;
import com.cdu.SoulMate.model.entity.User;
import com.cdu.SoulMate.model.request.UpdateTagRequest;
import com.cdu.SoulMate.model.request.UserQueryRequest;
import com.cdu.SoulMate.model.request.UserUpdatePassword;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public String redisFormat(Long key) {
        return String.format("soul_mate:user:search:%s", key);
    }
    /**
     * String类型集合首字母大写
     *
