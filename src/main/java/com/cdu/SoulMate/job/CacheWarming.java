package com.cdu.SoulMate.job;

import cn.hutool.core.date.DateUnit;
import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.RandomUtil;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.cdu.SoulMate.contant.FriendConstant;
import com.cdu.SoulMate.model.entity.Friends;
import com.cdu.SoulMate.model.entity.Team;
import com.cdu.SoulMate.model.entity.User;
import com.cdu.SoulMate.model.vo.TeamUserVo;
import com.cdu.SoulMate.service.ChatService;
import com.cdu.SoulMate.service.FriendsService;
            ...
            if (rLock.tryLock(0, -1, TimeUnit.MILLISECONDS)) {
                ...
                friendsList.forEach(friends -> {
                    if (DateUtil.between(new Date(), friends.getCreateTime(), DateUnit.DAY) >= 3) {
                        if (friends.getStatus() != FriendConstant.EXPIRED_STATUS && friends.getStatus() != FriendConstant.AGREE_STATUS) {
                            friends.setStatus(2);
