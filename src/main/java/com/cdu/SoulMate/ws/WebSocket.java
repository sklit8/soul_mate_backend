package com.cdu.SoulMate.ws;

import cn.hutool.core.date.DateUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.cdu.SoulMate.config.HttpSessionConfigurator;
import com.cdu.SoulMate.contant.ChatConstant;
import com.cdu.SoulMate.contant.UserConstant;
...
import com.cdu.SoulMate.model.request.MessageRequest;
...
public class WebSocket {
    ...
    public void onOpen(Session session, @PathParam(value = "userId") String userId, @PathParam(value = "teamId") String teamId, EndpointConfig config) {
        try {
            ...
            User user = (User) httpSession.getAttribute(UserConstant.LOGIN_USER_STATUS);
            if (user != null) {
    ...
    private void teamChat(User user, String text, Team team, Integer chatType) {
        ...
        User loginUser = (User) this.httpSession.getAttribute(UserConstant.LOGIN_USER_STATUS);
    ...
    private void savaChat(Long userId, Long toId, String text, Long teamId, Integer chatType) {
        if (chatType == ChatConstant.PRIVATE_CHAT) {
            ...
            Set<Long> userIds = com.cdu.SoulMate.utils.StringUtils.stringJsonListToLongSet(user.getUserIds());
